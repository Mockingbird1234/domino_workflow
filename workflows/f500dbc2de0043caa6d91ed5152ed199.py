...
dag_config_0 = {'start_date': '2026-04-23T07:59:00', 'schedule': '@once', 'catchup': False, 'dag_id': 'f500dbc2de0043caa6d91ed5152ed199'}
...
with DAG(**dag_config) as dag:
    HttpReques_27dd10b0cd4b41a5bb118468b0a3c60b = Task(
        ...
        piece_input_kwargs={'url': 'https://tse3.mm.bing.net/th/id/OIP.XV-mvuX9EN2Pn0BZvhdf1gHaEK?rs=1&pid=ImgDetMain&o=7&rm=3', 'method': 'GET'}
    )()
